...
## Figure 1. Recoverability budget map

Conceptual map from task and risk contract to resource allocation, representation choice, verification, fallback, and abstention. This is a conceptual systems figure, not a measured result.

## Figure 2. Repository evidence atlas overview

Overview of the 24 normalized repository hypotheses, grouped by category and colored by evidence status. Disposition labels are descriptive summaries rather than new verdicts.
...
Conceptual decision flow from task contract to exact structural preservation, approximate representation, native decoder choice, verification, fallback, and abstention. This is an architectural synthesis figure rather than a benchmark plot.
