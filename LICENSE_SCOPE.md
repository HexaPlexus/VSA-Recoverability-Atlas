...
The repository currently includes Apache-2.0 as its top-level license text in [LICENSE](LICENSE).
...
This file is a repository-scope note for readers. It is not legal advice, and it does not relicense third-party material.
